...
- Deploy pitstop to Alice (.49) with systemd auto-start
...
- Add NLP intent routing: 'block domain' / 'dns stats'
- Create PitStop Agent persona with RoundTrip auto-chat
- Integrate with RoadMem for persistent state across restarts
- Add Codex solution entries for common pitstop operations
- Build blackroad-operator CLI commands: `br pitstop status|deploy|logs`
...
- Contribute BlackRoad improvements back to upstream Pi-hole
